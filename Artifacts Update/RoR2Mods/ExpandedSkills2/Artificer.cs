    ...
    public static class Artificer
    {
        public static void Setup()
        {
            ...
            LoadoutAPI.AddSkill(typeof(VTStates.States.Mage.FireSeekingProjectile));
            {
                ...
                mySkillDef.skillDescriptionToken = "Launch 2 <style=cIsUtility>homing</style> bolts of fire, dealing <style=cIsDamage> 100% Damage</style> each";
            ...
            LoadoutAPI.AddSkill(typeof(VTStates.States.Mage.GravBomb));
            {
                ...
                mySkillDef.stockToConsume = 1;
                //mySkillDef.icon = Resources.Load<Sprite>()
                mySkillDef.skillDescriptionToken = "Launch a <style=cIsUtility>tethering black hole</style> that explodes on impact with the world, dealing <style=cIsDamage> 1000% Damage</style>";
